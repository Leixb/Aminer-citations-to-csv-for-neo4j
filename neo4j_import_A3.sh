...
#
# This imports the data from CSV files generated by the parser program into
# neo4j.
#
# This is for task A.3 of the assignment.
#
# The difference from A.2 is that it creates university and company nodes and
# reviews are nodes instead of edges.
###############################################################################
